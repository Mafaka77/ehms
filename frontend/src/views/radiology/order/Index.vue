        ...
        <table class="w-full border-collapse text-left whitespace-nowrap">
          <thead>
            <tr class="bg-slate-50 border-b border-slate-100">
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider">Order No</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider">Date</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider">Patient</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider">Doctor</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider">Priority</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider text-right">Amount</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider text-center">Payment</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider text-center">Status</th>
              <th class="text-slate-400 font-bold text-[11px] uppercase px-6 py-4 tracking-wider text-center">Actions</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-slate-100">
            <tr v-for="i in 5" :key="i" class="animate-pulse">
              ...
              <td class="px-6 py-4"><div class="h-5 bg-slate-200 rounded w-14"></div></td>
              ...
              <td class="px-6 py-4 text-center"><div class="h-5 bg-slate-200 rounded w-20 mx-auto"></div></td>
              <td class="px-6 py-4 text-center"><div class="h-8 bg-slate-200 rounded w-16 mx-auto"></div></td>
            </tr>
          </tbody>
        </table>
      </div>
