  ...
  <div class="space-y-8">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-slate-500 mt-1 text-sm">Welcome back! Here is what's happening today.</p>
      </div>
      <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-medium text-sm shadow-lg shadow-indigo-200 transition-all transform active:scale-95 flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div class="relative z-10 flex justify-between items-start">
          <div>
            ...
            <h3 class="text-3xl font-bold text-slate-900 mt-2">1,248</h3>
      ...
      <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div class="relative z-10 flex justify-between items-start">
          <div>
            ...
            <h3 class="text-3xl font-bold text-slate-900 mt-2">42</h3>
            <p class="text-xs font-medium text-emerald-500 mt-2 flex items-center">
              <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" /></svg>
              5% from yesterday
            </p>
      ...
      <!-- Stat Card 3 -->
      <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        <div class="absolute -right-4 -top-4 w-24 h-24 bg-rose-50 rounded-full group-hover:scale-150 transition-transform duration-500 ease-out z-0"></div>
        <div class="relative z-10 flex justify-between items-start">
          <div>
            <p class="text-sm font-medium text-slate-500">Critical Cases</p>
            <h3 class="text-3xl font-bold text-slate-900 mt-2">8</h3>
            <p class="text-xs font-medium text-rose-500 mt-2 flex items-center">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div class="relative z-10 flex justify-between items-start">
          <div>
            ...
            <h3 class="text-3xl font-bold text-slate-900 mt-2">$24.5k</h3>
            <p class="text-xs font-medium text-emerald-500 mt-2 flex items-center">
              <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" /></svg>
              18% this month
            </p>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
      ...
      <div class="p-6 text-center text-slate-500 py-20">
