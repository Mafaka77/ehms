...
const generateInvoicePDF = async () => {
  ...
  try {
    ...
    const filename = `Dental_Receipt_${patientName}.pdf`
        ...
        <div v-show="!pdfPreviewUrl" class="absolute inset-0 overflow-y-auto bg-slate-200 p-8 flex justify-center z-0">
          <div ref="receiptRef" class="opd-print-receipt-container select-none bg-white">
            ...
            <div class="receipt-header">
              ...
              <h2>DENTAL CONSULTATION BILL / INVOICE</h2>
            </div>
            ...
            <div class="demographics">
              <div>
                ...
                <p><strong>Payment Mode:</strong> <span class="font-mono uppercase">{{ installment.paymentId?.paymentMode || installment.paymentMode || 'N/A' }}</span></p>
              </div>
              <div class="text-right">
