...
module.exports = async (fastify, options) => {
    ...
    fastify.put('/charge-categories/:id', { onRequest: [auth, authorizeRole(['SuperAdmin', 'HospitalAdmin','Nurse'])] }, ipdController.updateChargeCategory)
    ...
    // Newborn Discharge Summary routes
