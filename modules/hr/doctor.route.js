...
module.exports = async function (fastify, opts) {
    ...
    fastify.put('/doctors/:id', { onRequest: [auth, authorizeRole(['SuperAdmin', 'HospitalAdmin'])] }, doctorController.updateDoctor);
    fastify.delete('/doctors/:id', { onRequest: [auth, authorizeRole(['SuperAdmin', 'HospitalAdmin'])] }, doctorController.deleteDoctor);
