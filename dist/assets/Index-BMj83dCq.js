        ...
        <body>
          ...
          <div class="receipt-header">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
              <img src="${S}" alt="Logo" style="height: 60px; width: auto; object-fit: contain;" />
